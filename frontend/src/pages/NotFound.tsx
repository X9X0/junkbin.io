    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4">
      <div className="text-center">
        ...
        <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-4">
          NO USER SERVICEABLE
          <span className="block text-cyber-pink">PARTS INSIDE</span>
        </h2>
        ...
        <p className="text-gray-400 max-w-md mx-auto mb-8 font-mono text-sm">
          ...
          currently being reverse-engineered.
        </p>

        {/* Terminal-style error */}
        <div className="max-w-md mx-auto mb-8 text-left">
          <div className="terminal">
            <p className="text-cyber-pink">ERROR: PAGE_NOT_FOUND</p>
            <p className="text-gray-500 mt-1">
              &gt; Requested resource unavailable
            </p>
            <p className="text-gray-500">
              &gt; Check URL or return to main system
            </p>
          </div>
        </div>
